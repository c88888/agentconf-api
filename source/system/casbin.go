...
func (i *initCasbin) InitializeData(ctx context.Context) (context.Context, error) {
	...
	entities := []adapter.CasbinRule{
		...
		{Ptype: "p", V0: "101", V1: "/user/admin_register", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/api/createApi", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/api/getApiList", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/api/getApiById", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/api/deleteApi", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/api/updateApi", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/api/getAllApis", V2: "POST"},

		{Ptype: "p", V0: "101", V1: "/authority/createAuthority", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/authority/deleteAuthority", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/authority/getAuthorityList", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/authority/setDataAuthority", V2: "POST"},

		{Ptype: "p", V0: "101", V1: "/menu/getMenu", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/menu/getMenuList", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/menu/addBaseMenu", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/menu/getBaseMenuTree", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/menu/addMenuAuthority", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/menu/getMenuAuthority", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/menu/deleteBaseMenu", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/menu/updateBaseMenu", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/menu/getBaseMenuById", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/user/changePassword", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/user/getUserList", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/user/setUserAuthority", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/fileUploadAndDownload/upload", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/fileUploadAndDownload/getFileList", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/fileUploadAndDownload/deleteFile", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/fileUploadAndDownload/editFileName", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/casbin/updateCasbin", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/casbin/getPolicyPathByAuthorityId", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/jwt/jsonInBlacklist", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/system/getSystemConfig", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/system/setSystemConfig", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/customer/customer", V2: "PUT"},
		{Ptype: "p", V0: "101", V1: "/customer/customer", V2: "GET"},
		{Ptype: "p", V0: "101", V1: "/customer/customer", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/customer/customer", V2: "DELETE"},
		{Ptype: "p", V0: "101", V1: "/customer/customerList", V2: "GET"},
		{Ptype: "p", V0: "101", V1: "/autoCode/createTemp", V2: "POST"},
		{Ptype: "p", V0: "101", V1: "/user/getUserInfo", V2: "GET"},
	}
...
func (i *initCasbin) DataInserted(ctx context.Context) bool {
	...
	if errors.Is(db.Where(adapter.CasbinRule{Ptype: "p", V0: "101", V1: "/user/getUserInfo", V2: "GET"}).
